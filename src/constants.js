...
const constants = {
    orbAmounts: [0, 0, 50, 75, 125, 175, 225, 275, 350, 425, 500],
    demonTypes: ["Unknown", "Hard", "Unknown", "Easy", "Medium", "Insane", "Extreme"],
    ratingColors: {
        "Official": "cyan",
        "Epic": "#ff8000",
        "Featured": "yellow",
    ...
    rewardKeys: {
        1: { name: "item", bump: ["Fire Shard", "Ice Shard", "Poison Shard", "Shadow Shard", "Lava Shard", "Demon Key", "Mana Orbs", "Diamonds", "Icon"] },
        2: "iconID",
        3: "amount",
        4: { name: "iconForm", bump: ["cube", "color1", "color2", "ship", "ball", "ufo", "wave", "robot", "spider", "trail", "deathEffect"] }
    },

    starDifficulties: ["Unrated", "Auto", "Easy", "Normal", "Hard", "Hard", "Harder", "Harder", "Insane", "Insane", "Demon"],
    ...
    levelKeys: {
        ...
        "k22": "likes",
        "k23": { name: "length", arr: ["Tiny", "Short", "Medium", "Long", "XL"] },
        "k24": "dislikes",
        "k25": "demon",
        "k26": "stars",
